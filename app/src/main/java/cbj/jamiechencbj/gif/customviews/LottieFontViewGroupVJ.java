package cbj.jamiechencbj.gif.customviews;
...
public class LottieFontViewGroupVJ extends FrameLayout {
    ...
    public LottieFontViewGroupVJ(Context context) {
        super(context);
        init();
    }

    public LottieFontViewGroupVJ(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public LottieFontViewGroupVJ(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        LottieComposition.Factory.fromAssetFileName(getContext(), "Mobilo/BlinkingCursor.json",
                new OnCompositionLoadedListener() {
                    ...
                    public void onCompositionLoaded(LottieComposition composition) {
                        ...
                        cursorView.setLayoutParams(new LottieFontViewGroupVJ.LayoutParams(
    ...
    private void addComposition(LottieComposition composition) {
        ...
        lottieAnimationView.setLayoutParams(new LottieFontViewGroupVJ.LayoutParams(
                ViewGroup.LayoutParams.WRAP_CONTENT,
                ViewGroup.LayoutParams.WRAP_CONTENT
        ));
    ...
    private void addToInputString(String inputLetter) {
        inputString = inputString + inputLetter;
        GifLogger.d("inputString: "+inputString);
    }

    private void removeFromInputString() {
